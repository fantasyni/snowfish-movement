...
let MODULE_NAME: string = "math128";
...
function log2_64(arg0: u64_import): [FixedPoint64] {
    let wasm = get_wasm();
    ...
    let [r0] = wasm.call_return_bcs(PACKAGE_ADDRESS, MODULE_NAME, "log2_64", [], args);
