...
function address_from_bytes(arg0: number[]): [string] {
    let wasm = get_wasm();
    ...
    let [r0] = wasm.call_return_bcs(PACKAGE_ADDRESS, MODULE_NAME, "address_from_bytes", [], args);
