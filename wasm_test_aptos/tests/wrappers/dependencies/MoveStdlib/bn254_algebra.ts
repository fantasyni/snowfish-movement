...
let MODULE_NAME: string = "bn254_algebra";
...
export class FormatFqLsb implements StructClass {
    $type: string = `${do_get_package_address()}::${MODULE_NAME}::FormatFqLsb`;
    ...
    from_bcs(arg: any) {
        return FormatFqLsb.from_bcs(arg)
    }

    from_bcs_vector(args: any) {
        return FormatFqLsb.from_bcs_vector(args)
    }

    get_bcs() {
        return FormatFqLsb.bcs
    }
    ...
    static $type() {
        return `${do_get_package_address()}::${MODULE_NAME}::FormatFqLsb`
    }

    from(arg: FormatFqLsb) {
        this.dummy_field = arg.dummy_field;
    }
    ...
    static from_bcs(arg: {
        ...
        return new FormatFqLsb(arg.dummy_field)
    }
    ...
    static get bcs() {
        return bcs_import.struct("FormatFqLsb", {
            dummy_field: bcs_import.bool(),
        }).transform({
            input: (val: any) => {
                return val
            },
            output: (val) => new FormatFqLsb(val.dummy_field),
        });
    };
}
...
export class FormatFqMsb implements StructClass {
    $type: string = `${do_get_package_address()}::${MODULE_NAME}::FormatFqMsb`;
    ...
    from_bcs(arg: any) {
        return FormatFqMsb.from_bcs(arg)
    }

    from_bcs_vector(args: any) {
        return FormatFqMsb.from_bcs_vector(args)
    }

    get_bcs() {
        return FormatFqMsb.bcs
    }
    ...
    static $type() {
        return `${do_get_package_address()}::${MODULE_NAME}::FormatFqMsb`
    }

    from(arg: FormatFqMsb) {
        this.dummy_field = arg.dummy_field;
    }
    ...
    static from_bcs(arg: {
        ...
        return new FormatFqMsb(arg.dummy_field)
    }
    ...
    static get bcs() {
        return bcs_import.struct("FormatFqMsb", {
            dummy_field: bcs_import.bool(),
        }).transform({
            input: (val: any) => {
                return val
            },
            output: (val) => new FormatFqMsb(val.dummy_field),
        });
    };
}
...
export class Fq implements StructClass {
    $type: string = `${do_get_package_address()}::${MODULE_NAME}::Fq`;
    ...
    from_bcs(arg: any) {
        return Fq.from_bcs(arg)
    }

    from_bcs_vector(args: any) {
        return Fq.from_bcs_vector(args)
    }
    ...
    static $type() {
        return `${do_get_package_address()}::${MODULE_NAME}::Fq`
    }
    ...
    static get bcs() {
        return bcs_import.struct("Fq", {
            dummy_field: bcs_import.bool(),
        }).transform({
            input: (val: any) => {
                return val
            },
            output: (val) => new Fq(val.dummy_field),
        });
    };
}
